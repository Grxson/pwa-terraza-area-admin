...
@endif
        ...
        <div class="d-flex justify-content-center">
            <div class="w-100" style="max-width: 600px;">
                <form method="POST" action="{{ url('Coupon.store') }}" enctype="multipart/form-data">
                    @csrf
                    <!-- Nombre del producto -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control mx-auto" name="descuento" id="descuento" placeholder="Porcentaje" value="{{old('descuento')}}">
                        @error('precio')
                            <div class="alert alert-danger" role="alert">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control mx-auto" name="costoPuntos" id="costoPuntos" placeholder="Valor puntos" value="{{old('costoPuntos')}}">
                        @error('valorPuntos')
                            <div class="alert alert-danger" role="alert">{{ $message }}</div>
                        @enderror
                    </div>
