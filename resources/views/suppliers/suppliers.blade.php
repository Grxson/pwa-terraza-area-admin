                ...
                <tbody>
                    ...
                    <tr>
                       ...
                       <td>{{$info['contact_phone']}}</td>
                        ...
                        <td><a href="{{url('suppliers/supplier_editar/'.$info['id'])}}" class="btn btn-primary">Editar</a> |
                            <a href="{{url('supplier_cambiar_estauts/'.$info['id'])}}" class="btn btn-primary">Descontinuar</a>
                        </td>
